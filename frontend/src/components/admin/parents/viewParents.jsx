...
function ViewParents() {
  ...
  const [expanded, setExpanded] = useState(null); // Track expanded state by item._id
  ...
  // Handle expand/collapse for individual items by their id
  ...
  return (
    <>
      ...
      <div className="row m-3">
        {data.map((item) => (
          <Card
            key={item._id} // Added key for each card to be unique
            sx={{ maxWidth: 345 }}
          ...
          >
            ...
            <CardActions disableSpacing>
              ...
              <ExpandMore
                expand={expanded === item._id} // Only expand if the item's id matches
                onClick={() => handleExpandClick(item._id)} // Pass item._id to toggle expansion
